...
import GreetingArtifact from '../artifacts/contracts/Greetings.sol/Greeting.json'
    ...
    return (
        ...
        <>
            ...
            <StyledGreetingDiv>
                ...
                <StyledInput 
                id="greetingInput" 
                type="text" placeholder={greeting ? '' : 'Contract not yet deployed'}
                onChange={handleGreetingChange} />
                <StyledButton
                    disabled={!active || !greetingContract ? true : false} 
                    onClick={handleGreetingSubmit} >Submit</StyledButton>
            </StyledGreetingDiv>
        </>
    )
